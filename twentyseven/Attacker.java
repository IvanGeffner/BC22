...
public abstract class Attacker extends Robot {
    ...
    void checkChickenBehavior(){
        if (!chickenBehavior && Util.hurt(rc.getHealth(), rc.getType().getMaxHealth(0))) chickenBehavior = true;
    ...
    MapLocation getBestTarget(){
        ...
        if (chickenBehavior){
            ...
            if (ans != null){
                if (bestAttackingTarget != null && !Util.hurt(rc.getHealth(), rc.getType().getMaxHealth(0))){
    ...
    MapLocation getBestAttackingTarget(){
