...
public class Pathfinding {
    ...
    boolean canMove(Direction dir){
        ...
        //if (impassable[dir.ordinal()]) return false; TODO
        return true;
    }
    ...
    void greedyPath(){
        try {
            ...
            for (Direction dir : directions) {
                ...
                //pass
                avgRubble += rc.senseRubble(newLoc);
                ++contPassability;
            ...
            if (contPassability != 0) {
                avgRubbleInv = avgRubble / contPassability;
            }
