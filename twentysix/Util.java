...
public class Util {
    ...
    static Integer minSoldiers;

    static int getMinSoldiers(){
        if (minSoldiers != null) return minSoldiers;
        minSoldiers = 3 + (Robot.rc.getMapHeight()* Robot.rc.getMapWidth())/200;
        if (minSoldiers > Constants.INITIAL_MINERS) minSoldiers = Constants.INITIAL_MINERS;
        return minSoldiers;
        //return Constants.INITIAL_MINERS;
    }
