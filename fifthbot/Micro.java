...
public class Micro {
    ...
    static double myDPS;
    static final int MAX_MICRO_BYTECODE_REMAINING = 1000;
    ...
    Micro(RobotController rc){
        ...
        rangeExtended[RobotType.SOLDIER.ordinal()] = 25;
        rangeExtended[RobotType.SAGE.ordinal()] = 25;
    ...
    final static int MAX_RUBBLE_DIFF = 3;
