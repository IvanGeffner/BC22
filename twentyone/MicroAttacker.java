...
public class MicroAttacker extends Micro {
    ...
    class MicroInfo{
        ...
        void updateEnemy(RobotInfo unit){
            ...
            if (unit.getType() != RobotType.ARCHON && dist <= currentActionRadius) DPSreceived += currentDPS;
