...
public class MicroSage {
    ...
    boolean doMicro(){
        try {
            ...
            MicroAttacker.MicroInfo[] microInfo = new MicroAttacker.MicroInfo[9];
            for (int i = 0; i < 9; ++i) microInfo[i] = new MicroAttacker.MicroInfo(dirs[i]);
            ...
            MicroAttacker.MicroInfo bestMicro = microInfo[8];
            for (int i = 0; i < 8; ++i) {
    ...
    class MicroInfo{
        ...
        //equal => true
        boolean isBetter(MicroAttacker.MicroInfo M){
